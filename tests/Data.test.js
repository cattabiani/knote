...
describe('Data module', () => {
  ...
  it('flipDone chain', () => {
    const A = Data.addNewNode(data, 'A', 'root')
    const B = Data.addNewNode(data, 'B', A.id)
    const C = Data.addNewNode(data, 'C', A.id)
    const D = Data.addNewNode(data, 'D', C.id)
    const E = Data.addNewNode(data, 'E', C.id)
    Data.flipDone(data, B.id)
    Data.flipDone(data, C.id)
    expect(A.done).toBe(true)
    Data.flipDone(data, D.id)
    Data.flipDone(data, E.id)
